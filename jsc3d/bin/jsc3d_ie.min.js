...
new JSC3D.Matrix3x4;this.sceneUrl="";this.modelColor=13280792;this.bkgColor1=16777215;this.bkgColor2=3684416;this.renderMode="flat";this.definition="standard";this.isMipMappingOn=false;this.sphereMapUrl="";this.buttonStates={};this.keyStates={};this.mouseY=this.mouseX=0;this.afterupdate=this.beforeupdate=this.onmousemove=this.onmouseup=this.onmousedown=null;this.isDefaultInputHandlerEnabled=true;var e=this;b.attachEvent("onmousedown",function(f){e.mouseDownHandler(f)});b.attachEvent("onmouseup",function(f){e.mouseUpHandler(f)});
b.attachEvent("onmousemove",function(f){e.mouseMoveHandler(f)});document.attachEvent("onkeydown",function(f){e.keyDownHandler(f)});document.attachEvent("onkeyup",function(f){e.keyUpHandler(f)})};a=JSC3D.Viewer.prototype;a.setParameter=function(b,c){this.params[b]=c};
