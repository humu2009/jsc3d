...
a.fillGradientBackground=function(){for(var b=this.frameWidth,c=this.frameHeight,d=this.bkgColorBuffer,e=(this.bkgColor1&16711680)>>16,f=(this.bkgColor1&65280)>>8,g=this.bkgColor1&255,h=(this.bkgColor2&16711680)>>16,i=(this.bkgColor2&65280)>>8,m=this.bkgColor2&255,o=0,u=0;u<c;u++)for(var j=e+u*(h-e)/c&255,B=f+u*(i-f)/c&255,n=g+u*(m-g)/c&255,M=0;M<b;M++)d[o++]=j<<16|B<<8|n};
...
a.endScene=function(){var b=this.canvasData.data,c=this.canvas.width,d=this.canvas.height,e=this.colorBuffer,f=this.frameWidth,g=f*this.frameHeight;switch(this.definition){case "low":var h=c>>1,i=f-h,m=0,o=0;for(g=0;g<d;g++){for(var u=0;u<c;u++){f=e[m];b[o]=(f&16711680)>>16;b[o+1]=(f&65280)>>8;b[o+2]=f&255;b[o+3]=255;m+=u&1;o+=4}m+=g&1?i:-h}break;case "high":for(g=o=m=0;g<d;g++){for(u=0;u<c;u++){h=e[m];i=e[m+1];var j=e[m+f],B=e[m+f+1];b[o]=(h&16711680)+(i&16711680)+(j&16711680)+(B&16711680)>>18;b[o+
...
a.renderPoint=function(b){var c=this.frameWidth,d=c-1,e=this.frameHeight-1,f=b.transformedVertexBuffer,g=this.colorBuffer,h=this.zBuffer,i=this.selectionBuffer,m=f.length/3,o=b.internalId;b=b.material?b.material.diffuseColor:this.defaultMaterial.diffuseColor;for(var u=0,j=0;u<m;u++,j+=3){var B=~~(f[j]+0.5),n=~~(f[j+1]+0.5),M=f[j+2];if(B>=0&&B<d&&n>=0&&n<e){B=n*c+B;if(M>h[B]){h[B]=M;g[B]=b;i[B]=o}B++;if(M>h[B]){h[B]=M;g[B]=b;i[B]=o}B+=d;if(M>h[B]){h[B]=M;g[B]=b;i[B]=o}B++;if(M>h[B]){h[B]=M;g[B]=b;
i[B]=o}}}};
...
h[n++];if(b.isDoubleSided)J=J>0?J:-J;if(J<0){do;while(f[M++]!=-1)}else{var x,K;x=f[M++]*3;K=f[M++]*3;J=x;for(var H=false;!H;){var F=~~(g[x]+0.5),p=~~(g[x+1]+0.5),r=g[x+2],w=~~(g[K]+0.5),s=~~(g[K+1]+0.5),v=g[K+2],k=w-F,D=s-p,A=v-r,t,l,T;if(Math.abs(k)>Math.abs(D)){t=k;l=k>0?1:-1;T=k!=0?l*D/k:0;k=k!=0?l*A/k:0}else{t=D;T=D>0?1:-1;l=D!=0?T*k/D:0;k=D!=0?T*A/D:0}F=F;p=p;r=r;if(t<0){F=w;p=s;r=v;t=-t;l=-l;T=-T;k=-k}for(w=0;w<t;w++){if(F>=0&&F<d&&p>=0&&p<e){s=~~p*c+~~F;if(r>m[s]){m[s]=r;i[s]=B;o[s]=j}}F+=
l;p+=T;r+=k}if(K==J)H=true;else{x=K;K=f[M]!=-1?f[M++]*3:J}}M++}}};
a.renderSolidFlat=function(b){var c=this.frameWidth,d=this.frameHeight,e=b.indexBuffer,f=b.transformedVertexBuffer,g=b.transformedFaceNormalZBuffer,h=this.colorBuffer,i=this.zBuffer,m=this.selectionBuffer,o=b.faceCount,u=b.internalId,j=b.material?b.material:this.defaultMaterial,B=j.getPalette(),n=j.transparency==0,M=j.transparency*255,J=255-M;if(j.transparency!=1){if(!g||g.length<o){b.transformedFaceNormalZBuffer=new Array(o);g=b.transformedFaceNormalZBuffer}JSC3D.Math3D.transformVectorZs(this.rotMatrix,b.faceNormalBuffer,
g);j=new Array(3);for(var x=new Array(3),K=new Array(3),H=0,F=0;H<o;){var p=g[H++];if(b.isDoubleSided)p=p>0?p:-p;if(p<0){do;while(e[F++]!=-1)}else{p=B[~~(p*255)];var r,w,s;r=e[F++]*3;w=e[F++]*3;do{s=e[F++]*3;j[0]=~~(f[r]+0.5);x[0]=~~(f[r+1]+0.5);K[0]=f[r+2];j[1]=~~(f[w]+0.5);x[1]=~~(f[w+1]+0.5);K[1]=f[w+2];j[2]=~~(f[s]+0.5);x[2]=~~(f[s+1]+0.5);K[2]=f[s+2];w=x[0]<x[1]?0:1;w=x[w]<x[2]?w:2;var v=x[0]>x[1]?0:1;v=x[v]>x[2]?v:2;var k=3-v-w;if(w!=v){var D=j[v],A=K[v],t=x[v]-x[w];t=t!=0?t:1;var l=(j[v]-j[w])/
t;t=(K[v]-K[w])/t;var T=j[v],y=K[v],E=x[v]-x[k];E=E!=0?E:1;var C=(j[v]-j[k])/E;E=(K[v]-K[k])/E;var q=j[k],la=K[k],z=x[k]-x[w];z=z!=0?z:1;var ra=(j[k]-j[w])/z;z=(K[k]-K[w])/z;var ma=x[v]*c;for(v=x[v];v>x[w];v--){if(v>=0&&v<d){var Q=~~D,V=A,G,sa;if(v>x[k]){G=~~T;sa=y}else{G=~~q;sa=la}if(Q>G){var da;da=Q;Q=G;G=da;da=V;V=sa;sa=da}if(Q<0)Q=0;if(G>=c)G=c-1;sa=Q!=G?(sa-V)/(G-Q):1;da=ma+Q;if(n){Q=Q;for(V=V;Q<=G;Q++,V+=sa){if(V>i[da]){i[da]=V;h[da]=p;m[da]=u}da++}}else{Q=Q;for(V=V;Q<G;Q++,V+=sa){if(V>i[da]){var ya=
h[da];h[da]=(ya&16711680)*M+(p&16711680)*J>>8&16711680|(ya&65280)*M+(p&65280)*J>>8&65280|(ya&255)*M+(p&255)*J>>8&255;m[da]=u}da++}}}D-=l;A-=t;if(v>x[k]){T-=C;y-=E}else{q-=ra;la-=z}ma-=c}}w=s}while(e[F]!=-1);F++}}}};
a.renderSolidSmooth=function(b){var c=this.frameWidth,d=this.frameHeight,e=b.indexBuffer,f=b.transformedVertexBuffer,g=b.transformedVertexNormalZBuffer,h=b.vertexNormalIndexBuffer?b.vertexNormalIndexBuffer:b.indexBuffer,i=b.transformedFaceNormalZBuffer,m=this.colorBuffer,o=this.zBuffer,u=this.selectionBuffer,j=b.faceCount,B=b.internalId,n=b.material?b.material:this.defaultMaterial,M=n.getPalette(),J=n.transparency==0,x=n.transparency*255,K=255-x;if(n.transparency!=1){if(!g||g.length<b.vertexNormalBuffer.length/
...
}else{var v,k,D,A,t;s=e[w]*3;D=h[w];w++;k=e[w]*3;A=h[w];w++;do{v=e[w];v=v*3;t=h[w];w++;n[0]=~~(f[s]+0.5);H[0]=~~(f[s+1]+0.5);F[0]=f[s+2];n[1]=~~(f[k]+0.5);H[1]=~~(f[k+1]+0.5);F[1]=f[k+2];n[2]=~~(f[v]+0.5);H[2]=~~(f[v+1]+0.5);F[2]=f[v+2];p[0]=g[D];p[1]=g[A];p[2]=g[t];if(b){if(p[0]<0)p[0]=-p[0];if(p[1]<0)p[1]=-p[1];if(p[2]<0)p[2]=-p[2]}k=H[0]<H[1]?0:1;k=H[k]<H[2]?k:2;var l=H[0]>H[1]?0:1;l=H[l]>H[2]?l:2;A=3-l-k;if(k!=l){var T=n[l],y=F[l],E=p[l]*255,C=H[l]-H[k];C=C!=0?C:1;var q=(n[l]-n[k])/C,la=(F[l]-
F[k])/C;C=(p[l]-p[k])*255/C;var z=n[l],ra=F[l],ma=p[l]*255,Q=H[l]-H[A];Q=Q!=0?Q:1;var V=(n[l]-n[A])/Q,G=(F[l]-F[A])/Q;Q=(p[l]-p[A])*255/Q;var sa=n[A],da=F[A],ya=p[A]*255,ta=H[A]-H[k];ta=ta!=0?ta:1;var ea=(n[A]-n[k])/ta,Ea=(F[A]-F[k])/ta;ta=(p[A]-p[k])*255/ta;var Da=H[l]*c;for(l=H[l];l>H[k];l--){if(l>=0&&l<d){var S=~~T,Y=y,na=E,oa,ua,ja;if(l>H[A]){oa=~~z;ua=ra;ja=ma}else{oa=~~sa;ua=da;ja=ya}if(S>oa){var fa;fa=S;S=oa;oa=fa;fa=Y;Y=ua;ua=fa;fa=na;na=ja;ja=fa}ua=S!=oa?(ua-Y)/(oa-S):1;ja=S!=oa?(ja-na)/
(oa-S):1;if(S<0){Y-=S*ua;na-=S*ja;S=0}if(oa>=c)oa=c-1;fa=Da+S;if(J){S=S;Y=Y;for(na=na;S<=oa;S++,Y+=ua,na+=ja){if(Y>o[fa]){o[fa]=Y;m[fa]=M[na>0?~~na:0];u[fa]=B}fa++}}else{S=S;Y=Y;for(na=na;S<oa;S++,Y+=ua,na+=ja){if(Y>o[fa]){var pa=M[na>0?~~na:0],va=m[fa];m[fa]=(va&16711680)*x+(pa&16711680)*K>>8&16711680|(va&65280)*x+(pa&65280)*K>>8&65280|(va&255)*x+(pa&255)*K>>8&255;u[fa]=B}fa++}}}T-=q;y-=la;E-=C;if(l>H[A]){z-=V;ra-=G;ma-=Q}else{sa-=ea;da-=Ea;ya-=ta}Da-=c}}k=v;A=t}while(e[w]!=-1);w++}}}};
a.renderSolidTexture=function(b){var c=this.frameWidth,d=this.frameHeight,e=b.indexBuffer,f=b.transformedVertexBuffer,g=b.transformedFaceNormalZBuffer,h=this.colorBuffer,i=this.zBuffer,m=this.selectionBuffer,o=b.faceCount,u=b.internalId,j=b.texture,B=!j.hasTransparency,n=b.texCoordBuffer,M=b.texCoordIndexBuffer?b.texCoordIndexBuffer:b.indexBuffer,J=j.data,x=j.width,K=x-1,H=j.hasMipmap()?j.mipmaps:null,F=H?j.mipentries:null;if(!g||g.length<o){b.transformedFaceNormalZBuffer=new Array(o);g=b.transformedFaceNormalZBuffer}JSC3D.Math3D.transformVectorZs(this.rotMatrix,
b.faceNormalBuffer,g);for(var p=new Array(3),r=new Array(3),w=new Array(3),s=new Array(3),v=new Array(3),k=0,D=0;k<o;){var A=g[k++];if(b.isDoubleSided)A=A>0?A:-A;if(A<0){do;while(e[D++]!=-1)}else{var t,l,T,y,E;A=e[D]*3;T=M[D]*2;D++;t=e[D]*3;y=M[D]*2;D++;if(H){l=e[D]*3;E=M[D]*2;x=j.width;p[0]=f[A];r[0]=f[A+1];p[1]=f[t];r[1]=f[t+1];p[2]=f[l];r[2]=f[l+1];s[0]=n[T]*x;v[0]=n[T+1]*x;s[1]=n[y]*x;v[1]=n[y+1]*x;s[2]=n[E]*x;v[2]=n[E+1]*x;J=(p[1]-p[0])*(r[2]-r[0])-(r[1]-r[0])*(p[2]-p[0]);if(J<0)J=-J;J+=1;K=
(s[1]-s[0])*(v[2]-v[0])-(v[1]-v[0])*(s[2]-s[0]);if(K<0)K=-K;J=K/J;K=0;if(J<F[1])K=0;else if(J>=F[F.length-1]){K=F.length-1;x=1}else for(;J>=F[K+1];){K++;x/=2}J=H[K];K=x-1}do{l=e[D]*3;E=M[D]*2;D++;p[0]=~~(f[A]+0.5);r[0]=~~(f[A+1]+0.5);w[0]=f[A+2];p[1]=~~(f[t]+0.5);r[1]=~~(f[t+1]+0.5);w[1]=f[t+2];p[2]=~~(f[l]+0.5);r[2]=~~(f[l+1]+0.5);w[2]=f[l+2];s[0]=n[T]*x;v[0]=n[T+1]*x;s[1]=n[y]*x;v[1]=n[y+1]*x;s[2]=n[E]*x;v[2]=n[E+1]*x;t=r[0]<r[1]?0:1;t=r[t]<r[2]?t:2;var C=r[0]>r[1]?0:1;C=r[C]>r[2]?C:2;y=3-C-t;if(t!=
...
if(C>r[y]){U=~~sa;ka=da;ha=ya;I=ta}else{U=~~Y;ka=na;ha=oa;I=ua}if(aa>U){var L;L=aa;aa=U;U=L;L=ga;ga=ka;ka=L;L=wa;wa=ha;ha=L;L=O;O=I;I=L}ka=aa!=U?(ka-ga)/(U-aa):1;ha=aa!=U?(ha-wa)/(U-aa):1;I=aa!=U?(I-O)/(U-aa):1;if(aa<0){ga-=aa*ka;wa-=aa*ha;O-=aa*I;aa=0}if(U>=c)U=c-1;L=Fa+aa;if(B){aa=aa;ga=ga;wa=wa;for(O=O;aa<=U;aa++,ga+=ka,wa+=ha,O+=I){if(ga>i[L]){i[L]=ga;h[L]=J[(O&K)*x+(wa&K)];m[L]=u}L++}}else{aa=aa;ga=ga;wa=wa;for(O=O;aa<U;aa++,ga+=ka,wa+=ha,O+=I){if(ga>i[L]){var Z=J[(O&K)*x+(wa&K)],ca=h[L],P=Z>>
24&255,X=255-P;h[L]=(ca&16711680)*X+(Z&16711680)*P>>8&16711680|(ca&65280)*X+(Z&65280)*P>>8&65280|(ca&255)*X+(Z&255)*P>>8&255;m[L]=u}L++}}}q-=Q;la-=V;z-=G;ra-=ma;if(C>r[y]){sa-=Ea;da-=Da;ya-=S;ta-=ea}else{Y-=fa;na-=pa;oa-=va;ua-=ja}Fa-=c}}t=l;y=E}while(e[D]!=-1);D++}}};
...
null,w=r?n.mipentries:null;if(j.transparency!=1){if(!g||g.length<o){b.transformedFaceNormalZBuffer=new Array(o);g=b.transformedFaceNormalZBuffer}JSC3D.Math3D.transformVectorZs(this.rotMatrix,b.faceNormalBuffer,g);j=new Array(3);for(var s=new Array(3),v=new Array(3),k=new Array(3),D=new Array(3),A=0,t=0;A<o;){var l=g[A++];if(b.isDoubleSided)l=l>0?l:-l;if(l<0){do;while(e[t++]!=-1)}else{l=B[~~(l*255)];var T,y,E,C,q,la;T=e[t]*3;C=K[t]*2;t++;y=e[t]*3;q=K[t]*2;t++;if(r){E=e[t]*3;la=K[t]*2;F=n.width;j[0]=
...
ha+=ca){if(U>i[P]){i[P]=U;var X=H[(ha&p)*F+(ka&p)],N=((l&16711680)>>16)*((X&16711680)>>8),ba=((l&65280)>>8)*((X&65280)>>8),W=(l&255)*(X&255)>>8;h[P]=N&16711680|ba&65280|W&255;m[P]=u}P++}}else{O=O;U=U;ka=ka;for(ha=ha;O<I;O++,U+=L,ka+=Z,ha+=ca){if(U>i[P]){W=H[(ha&p)*F+(ka&p)];X=h[P];var ia=(W>>24&255)*(J&255)>>8;N=((l&16711680)>>16)*((W&16711680)>>8);ba=((l&65280)>>8)*((W&65280)>>8);W=(l&255)*(W&255)>>8;if(ia>250)i[P]=U;else{var R=255-ia;N=N*ia+(X&16711680)*R>>8;ba=ba*ia+(X&65280)*R>>8;W=W*ia+(X&255)*
R>>8}h[P]=N&16711680|ba&65280|W&255;m[P]=u}P++}}}ra-=sa;ma-=da;Q-=ya;V-=G;if(z>s[q]){ta-=Y;ea-=na;Ea-=oa;Da-=S}else{ua-=Fa;ja-=aa;fa-=ga;pa-=va}wa-=c}}y=E;q=la}while(e[t]!=-1);t++}}}};
...
F=b.texCoordIndexBuffer?b.texCoordIndexBuffer:b.indexBuffer,p=J.data,r=J.width,w=r-1,s=J.hasMipmap()?J.mipmaps:null,v=s?J.mipentries:null;if(n.transparency!=1){if(!g||g.length<b.vertexNormalBuffer.length/3){b.transformedVertexNormalZBuffer=new Array(b.vertexNormalBuffer.length/3);g=b.transformedVertexNormalZBuffer}if(!i||i.length<j){b.transformedFaceNormalZBuffer=new Array(j);i=b.transformedFaceNormalZBuffer}JSC3D.Math3D.transformVectorZs(this.rotMatrix,b.vertexNormalBuffer,g);JSC3D.Math3D.transformVectorZs(this.rotMatrix,
b.faceNormalBuffer,i);b=b.isDoubleSided;n=new Array(3);for(var k=new Array(3),D=new Array(3),A=new Array(3),t=new Array(3),l=new Array(3),T=0,y=0;T<j;){var E=i[T++];if(b)E=E>0?E:-E;if(E<0){do;while(e[y++]!=-1)}else{var C,q,la,z,ra,ma,Q,V;E=e[y]*3;la=F[y]*2;ma=h[y];y++;q=e[y]*3;z=F[y]*2;Q=h[y];y++;if(s){C=e[y]*3;ra=F[y]*2;r=J.width;n[0]=f[E];k[0]=f[E+1];n[1]=f[q];k[1]=f[q+1];n[2]=f[C];k[2]=f[C+1];t[0]=H[la]*r;l[0]=H[la+1]*r;t[1]=H[z]*r;l[1]=H[z+1]*r;t[2]=H[ra]*r;l[2]=H[ra+1]*r;p=(n[1]-n[0])*(k[2]-
k[0])-(k[1]-k[0])*(n[2]-n[0]);if(p<0)p=-p;p+=1;w=(t[1]-t[0])*(l[2]-l[0])-(l[1]-l[0])*(t[2]-t[0]);if(w<0)w=-w;p=w/p;w=0;if(p<v[1])w=0;else if(p>=v[v.length-1]){w=v.length-1;r=1}else for(;p>=v[w+1];){w++;r/=2}p=s[w];w=r-1}do{C=e[y];C=C*3;ra=F[y]*2;V=h[y];y++;n[0]=~~(f[E]+0.5);k[0]=~~(f[E+1]+0.5);D[0]=f[E+2];n[1]=~~(f[q]+0.5);k[1]=~~(f[q+1]+0.5);D[1]=f[q+2];n[2]=~~(f[C]+0.5);k[2]=~~(f[C+1]+0.5);D[2]=f[C+2];t[0]=H[la]*r;l[0]=H[la+1]*r;t[1]=H[z]*r;l[1]=H[z+1]*r;t[2]=H[ra]*r;l[2]=H[ra+1]*r;A[0]=g[ma];A[1]=
g[Q];A[2]=g[V];if(b){if(A[0]<0)A[0]=-A[0];if(A[1]<0)A[1]=-A[1];if(A[2]<0)A[2]=-A[2]}q=k[0]<k[1]?0:1;q=k[q]<k[2]?q:2;var G=k[0]>k[1]?0:1;G=k[G]>k[2]?G:2;z=3-G-q;if(q!=G){Q=n[G];var sa=D[G],da=t[G],ya=l[G],ta=A[G]*255,ea=k[G]-k[q];ea=ea!=0?ea:1;var Ea=(n[G]-n[q])/ea,Da=(D[G]-D[q])/ea,S=(t[G]-t[q])/ea,Y=(l[G]-l[q])/ea;ea=(A[G]-A[q])*255/ea;var na=n[G],oa=D[G],ua=t[G],ja=l[G],fa=A[G]*255,pa=k[G]-k[z];pa=pa!=0?pa:1;var va=(n[G]-n[z])/pa,Fa=(D[G]-D[z])/pa,aa=(t[G]-t[z])/pa,ga=(l[G]-l[z])/pa;pa=(A[G]-A[z])*
255/pa;var wa=n[z],O=D[z],U=t[z],ka=l[z],ha=A[z]*255,I=k[z]-k[q];I=I!=0?I:1;var L=(n[z]-n[q])/I,Z=(D[z]-D[q])/I,ca=(t[z]-t[q])/I,P=(l[z]-l[q])/I;I=(A[z]-A[q])*255/I;var X=k[G]*c;for(G=k[G];G>k[q];G--){if(G>=0&&G<d){var N=~~Q,ba=sa,W=da,ia=ya,R=ta,$,xa,za,Aa,Ba;if(G>k[z]){$=~~na;xa=oa;za=ua;Aa=ja;Ba=fa}else{$=~~wa;xa=O;za=U;Aa=ka;Ba=ha}if(N>$){var qa;qa=N;N=$;$=qa;qa=ba;ba=xa;xa=qa;qa=W;W=za;za=qa;qa=ia;ia=Aa;Aa=qa;qa=R;R=Ba;Ba=qa}xa=N!=$?(xa-ba)/($-N):1;za=N!=$?(za-W)/($-N):1;Aa=N!=$?(Aa-ia)/($-N):
1;Ba=N!=$?(Ba-R)/($-N):0;if(N<0){ba-=N*xa;W-=N*za;ia-=N*Aa;R-=N*Ba;N=0}if($>=c)$=c-1;qa=X+N;if(x){N=N;ba=ba;R=R;W=W;for(ia=ia;N<=$;N++,ba+=xa,R+=Ba,W+=za,ia+=Aa){if(ba>o[qa]){o[qa]=ba;var Ca=M[R>0?~~R:0],Ha=p[(ia&w)*r+(W&w)],Ia=((Ca&16711680)>>16)*((Ha&16711680)>>8),Ja=((Ca&65280)>>8)*((Ha&65280)>>8);Ca=(Ca&255)*(Ha&255)>>8;m[qa]=Ia&16711680|Ja&65280|Ca&255;u[qa]=B}qa++}}else{N=N;ba=ba;R=R;W=W;for(ia=ia;N<$;N++,ba+=xa,R+=Ba,W+=za,ia+=Aa){if(ba>o[qa]){Ca=M[R>0?~~R:0];var Ga=p[(ia&w)*r+(W&w)];Ha=m[qa];
var Ka=(Ga>>24&255)*(K&255)>>8;Ia=((Ca&16711680)>>16)*((Ga&16711680)>>8);Ja=((Ca&65280)>>8)*((Ga&65280)>>8);Ca=(Ca&255)*(Ga&255)>>8;if(Ka>250)o[qa]=ba;else{Ga=255-Ka;Ia=Ia*Ka+(Ha&16711680)*Ga>>8;Ja=Ja*Ka+(Ha&65280)*Ga>>8;Ca=Ca*Ka+(Ha&255)*Ga>>8}m[qa]=Ia&16711680|Ja&65280|Ca&255;u[qa]=B}qa++}}}Q-=Ea;sa-=Da;da-=S;ya-=Y;ta-=ea;if(G>k[z]){na-=va;oa-=Fa;ua-=aa;ja-=ga;fa-=pa}else{wa-=L;O-=Z;U-=ca;ka-=P;ha-=I}X-=c}}q=C;z=ra;Q=V}while(e[y]!=-1);y++}}}};
a.renderSolidSphereMapped=function(b){var c=this.frameWidth,d=this.frameHeight,e=b.indexBuffer,f=b.transformedVertexBuffer,g=b.transformedVertexNormalBuffer,h=b.vertexNormalIndexBuffer?b.vertexNormalIndexBuffer:b.indexBuffer,i=b.transformedFaceNormalZBuffer,m=this.colorBuffer,o=this.zBuffer,u=this.selectionBuffer,j=b.faceCount,B=b.internalId,n=b.material?b.material:this.defaultMaterial,M=n.getPalette(),J=this.sphereMap,x=J.data;J=J.width;var K=J-1,H=n.transparency==0,F=n.transparency*255,p=255-F;
...
k=new Array(3),D=0,A=0;D<j;){var t=i[D++];if(b)t=t>0?t:-t;if(t<0){do;while(e[A++]!=-1)}else{var l,T,y,E,C;t=e[A]*3;y=h[A]*3;A++;l=e[A]*3;E=h[A]*3;A++;do{T=e[A]*3;C=h[A]*3;A++;n[0]=~~(f[t]+0.5);r[0]=~~(f[t+1]+0.5);w[0]=f[t+2];n[1]=~~(f[l]+0.5);r[1]=~~(f[l+1]+0.5);w[1]=f[l+2];n[2]=~~(f[T]+0.5);r[2]=~~(f[T+1]+0.5);w[2]=f[T+2];s[0]=g[y];v[0]=g[y+1];k[0]=g[y+2];s[1]=g[E];v[1]=g[E+1];k[1]=g[E+2];s[2]=g[C];v[2]=g[C+1];k[2]=g[C+2];if(b){if(k[0]<0)k[0]=-k[0];if(k[1]<0)k[1]=-k[1];if(k[2]<0)k[2]=-k[2]}l=r[0]<
r[1]?0:1;l=r[l]<r[2]?l:2;var q=r[0]>r[1]?0:1;q=r[q]>r[2]?q:2;E=3-q-l;if(l!=q){var la=n[q],z=w[q],ra=k[q]*255,ma=(s[q]/2+0.5)*J&K,Q=(0.5-v[q]/2)*J&K,V=r[q]-r[l];V=V!=0?V:1;var G=(n[q]-n[l])/V,sa=(w[q]-w[l])/V,da=(k[q]-k[l])*255/V,ya=(s[q]-s[l])/2*J/V;V=(v[l]-v[q])/2*J/V;var ta=n[q],ea=w[q],Ea=k[q]*255,Da=(s[q]/2+0.5)*J&K,S=(0.5-v[q]/2)*J&K,Y=r[q]-r[E];Y=Y!=0?Y:1;var na=(n[q]-n[E])/Y,oa=(w[q]-w[E])/Y,ua=(k[q]-k[E])*255/Y,ja=(s[q]-s[E])/2*J/Y;Y=(v[E]-v[q])/2*J/Y;var fa=n[E],pa=w[E],va=k[E]*255,Fa=(s[E]/
2+0.5)*J&K,aa=(0.5-v[E]/2)*J&K,ga=r[E]-r[l];ga=ga!=0?ga:1;var wa=(n[E]-n[l])/ga,O=(w[E]-w[l])/ga,U=(k[E]-k[l])*255/ga,ka=(s[E]-s[l])/2*J/ga;ga=(v[l]-v[E])/2*J/ga;var ha=r[q]*c;for(q=r[q];q>r[l];q--){if(q>=0&&q<d){var I=~~la,L=z,Z=ra,ca=ma,P=Q,X,N,ba,W,ia;if(q>r[E]){X=~~ta;N=ea;ba=Ea;W=Da;ia=S}else{X=~~fa;N=pa;ba=va;W=Fa;ia=aa}if(I>X){var R;R=I;I=X;X=R;R=L;L=N;N=R;R=Z;Z=ba;ba=R;R=ca;ca=W;W=R;R=P;P=ia;ia=R}N=I!=X?(N-L)/(X-I):1;ba=I!=X?(ba-Z)/(X-I):1;W=I!=X?(W-ca)/(X-I):1;ia=I!=X?(ia-P)/(X-I):1;if(I<
0){L-=I*N;Z-=I*ba;ca-=ca*W;P-=P*ia;I=0}if(X>=c)X=c-1;R=ha+I;if(H){I=I;L=L;Z=Z;ca=ca;for(P=P;I<=X;I++,L+=N,Z+=ba,ca+=W,P+=ia){if(L>o[R]){o[R]=L;var $=M[Z>0?~~Z:0],xa=x[(P&K)*J+(ca&K)],za=(($&16711680)>>16)*((xa&16711680)>>8),Aa=(($&65280)>>8)*((xa&65280)>>8);$=($&255)*(xa&255)>>8;m[R]=za&16711680|Aa&65280|$&255;u[R]=B}R++}}else{I=I;L=L;Z=Z;ca=ca;for(P=P;I<X;I++,L+=N,Z+=ba,ca+=W,P+=ia){if(L>o[R]){$=M[Z>0?~~Z:0];var Ba=x[(P&K)*J+(ca&K)];xa=m[R];za=(($&16711680)>>16)*((Ba&16711680)>>8);Aa=(($&65280)>>
8)*((Ba&65280)>>8);$=($&255)*(Ba&255)>>8;za=za*p+(xa&16711680)*F>>8;Aa=Aa*p+(xa&65280)*F>>8;$=$*p+(xa&255)*F>>8;m[R]=za&16711680|Aa&65280|$&255;u[R]=B}R++}}}la-=G;z-=sa;ra-=da;ma-=ya;Q-=V;if(q>r[E]){ta-=na;ea-=oa;Ea-=ua;Da-=ja;S-=Y}else{fa-=wa;pa-=O;va-=U;Fa-=ka;aa-=ga}ha-=c}}l=T;E=C}while(e[A]!=-1);A++}}}};a.params=null;a.canvas=null;a.ctx=null;a.canvasData=null;a.bkgColorBuffer=null;a.colorBuffer=null;a.zBuffer=null;a.selectionBuffer=null;a.frameWidth=0;a.frameHeight=0;a.scene=null;
...
a.generateMipmaps=function(){if(!(this.width<=1||this.data==null||this.mipmaps!=null)){this.mipmaps=[this.data];this.mipentries=[1];for(var b=1+~~(0.1+Math.log(this.width)*Math.LOG2E),c=this.width>>1,d=1;d<b;d++){for(var e=new Array(c*c),f=this.mipmaps[d-1],g=c<<1,h=0,i=0,m=0;m<c;m++){for(var o=0;o<c;o++){var u=f[h],j=f[h+1],B=f[h+g],n=f[h+g+1];e[i]=(((u&4278190080)>>>2)+((j&4278190080)>>>2)+((B&4278190080)>>>2)+((n&4278190080)>>>2)&4278190080)+((u&16711680)+(j&16711680)+(B&16711680)+(n&16711680)>>
...
j=b.m20*this.m03+b.m21*this.m13+b.m22*this.m23+b.m23;this.m00=b.m00*this.m00+b.m01*this.m10+b.m02*this.m20;this.m01=c;this.m02=d;this.m03=e;this.m10=f;this.m11=g;this.m12=h;this.m13=i;this.m20=m;this.m21=o;this.m22=u;this.m23=j};
...
a.loadMtlFile=function(b,c,d){var e=c+d,f=this,g=new XMLHttpRequest;g.open("GET",e,true);g.onreadystatechange=function(){if(this.readyState==4){if(this.status==200||this.status==0){f.onprogress&&f.onprogress("Loading mtl file ...",1);JSC3D.console&&JSC3D.console.logInfo('Finished loading mtl file "'+e+'".');for(var h=f.parseMtl(this.responseText),i={},m=b.getChildren(),o=0;o<m.length;o++){var u=m[o];if(u.mtl!=null&&u.mtllib!=null&&u.mtllib==d){var j=h[u.mtl];if(j!=null){j.material!=null&&u.setMaterial(j.material);
...
a.loadFromUrl=function(b){var c=this,d=JSC3D.PlatformInfo.browser=="ie"&&parseInt(JSC3D.PlatformInfo.version)>=10,e=new XMLHttpRequest;e.open("GET",b,true);if(d)e.responseType="blob";else e.overrideMimeType("text/plain; charset=x-user-defined");e.onreadystatechange=function(){if(this.readyState==4)if(this.status==200||this.status==0){JSC3D.console&&JSC3D.console.logInfo('Finished loading STL file "'+b+'".');if(c.onload){c.onprogress&&c.onprogress("Loading STL file ...",1);if(d){var f=new FileReader;
f.onload=function(g){var h=new JSC3D.Scene;c.parseStl(h,g.target.result);c.onload(h)};f.readAsText(this.response,"x-user-defined")}else{f=new JSC3D.Scene;c.parseStl(f,this.responseText);c.onload(f)}}}else{JSC3D.console&&JSC3D.console.logError('Failed to load STL file "'+b+'".');c.onerror&&c.onerror('Failed to load STL file "'+b+'".')}};if(this.onprogress){this.onprogress("Loading STL file ...",0);e.onprogress=function(f){c.onprogress("Loading STL file ...",f.position/f.totalSize)}}e.send()};
a.setDecimalPrecision=function(b){this.decimalPrecision=b};
...
e;h={};for(g=0;g<e;g++){d.faceNormalBuffer.push(f.readFloat32());d.faceNormalBuffer.push(f.readFloat32());d.faceNormalBuffer.push(f.readFloat32());for(c=0;c<3;c++){i=f.readFloat32();m=f.readFloat32();o=f.readFloat32();u=i.toFixed(this.decimalPrecision)+"-"+m.toFixed(this.decimalPrecision)+"-"+o.toFixed(this.decimalPrecision);j=h[u];if(j==undefined){j=d.vertexBuffer.length/3;h[u]=j;d.vertexBuffer.push(i);d.vertexBuffer.push(m);d.vertexBuffer.push(o)}d.indexBuffer.push(j)}d.indexBuffer.push(-1);f.skip(2)}}else{f=
...
"ig");if(g=c.match(f)){e=g.length;d.faceCount=e;var h={};f.lastIndex=0;f.global=false;for(e=f.exec(c);e!=null;e=f.exec(c)){d.faceNormalBuffer.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3]));for(g=0;g<3;g++){var i=parseFloat(e[4+g*3]),m=parseFloat(e[5+g*3]),o=parseFloat(e[6+g*3]),u=i.toFixed(this.decimalPrecision)+"-"+m.toFixed(this.decimalPrecision)+"-"+o.toFixed(this.decimalPrecision),j=h[u];if(j===undefined){j=d.vertexBuffer.length/3;h[u]=j;d.vertexBuffer.push(i);d.vertexBuffer.push(m);
